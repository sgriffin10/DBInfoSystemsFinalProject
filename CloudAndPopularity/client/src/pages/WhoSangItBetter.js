...
export default class WhoSangItBetter extends React.Component {
    ...
    render() {
        return (
            <Box sx={{ width: maxWidth, height: maxHeight, bgcolor: '#011F5b' }} >
                <Box sx={{ bgcolor: '#011F5b', pt: 8, pb: 50 }} >
                    <Container maxWidth="sm">
                        ...
                        {!this.state.isLoading &&
                            <Typography variant="h5" align="center" color="#FFFFFF" paragraph sx={{ textDecoration: 'underline' }} >
                                {this.state.songName}
                            </Typography>
                        }
                        ...
                        <Typography sx={{ pt: 3 }} color = "#FFFFFF" align="center">
